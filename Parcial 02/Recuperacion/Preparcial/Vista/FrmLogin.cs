...
namespace Preparcial
{
    public partial class FrmLogin : Form
    {
        ...
        private void PoblarControlers()
        {
            ...
            //Correccion: Debe ser contrasena
        ...
        {
            //Correcion: Debe ser un "ShowDialog()" para luego poder actualizar contrasena 
            FrmPassword frmPassword = new FrmPassword();
            frmPassword.ShowDialog();
            //Correccion: Se tiene que volver a llamar la funcion para que se actualice a la contrasena nueva al regresar
            //al FrmLogin
            PoblarControlers();
        }
    }
